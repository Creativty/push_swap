...
/*   Updated: 2024/07/23 18:32:26 by abderrahim       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	input_line_buffer_cleanup(char buffer[BUFF_CAP])
{
	int	index;
	...
	return (index == -1 || index == BUFF_CAP - 1);
}
...
char	*input_readline(int fd)
{
	...
	{
		if (input_line_buffer_cleanup(buffer))
		{
